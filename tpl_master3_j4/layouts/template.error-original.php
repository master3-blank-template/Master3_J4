...
$errorLevelStr = $app->getConfig()->get('error_reporting', 'default');
$isShowFile = ($errorLevelStr === 'maximum') || ($errorLevelStr === 'simple');
$isBacktrace = $errorLevelStr === 'maximum';
...
<head>
    ...
    <link href="<?php echo Uri::base(true); ?>/templates/master3_j4/favicon.png" rel="shortcut icon" type="image/png" />
...
<body>
        ...
        <div class="uk-container">
            <div class="uk-navbar">
                <ul class="uk-navbar-nav">
                    <li><a href="<?php echo Uri::base(true) ?: '/'; ?>">
                        <?php echo Text::_('JERROR_LAYOUT_GO_TO_THE_HOME_PAGE'); ?></a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="uk-section uk-section-default">
        <div class="uk-container">
            <div>
                <h1>
                    <?php echo Text::_(($errorCode == 404 ? 'JERROR_LAYOUT_PAGE_NOT_FOUND'
                ...
                <div class="uk-h4 uk-margin-remove-top">
                    <?php echo htmlspecialchars($errorFile, ENT_QUOTES, 'UTF-8'), ':', $this->error->getLine(); ?>
                </div>
                <?php } ?>
                ...
                <div class="uk-margin-large-top">
                    ...
                    <p>
                            ...
                            echo
                                ...
                                htmlspecialchars($this->_error->getFile(), ENT_QUOTES, 'UTF-8'), ':',
                                $this->_error->getLine()
                            ;
                            ?>
                    </p>
