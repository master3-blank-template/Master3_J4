...
$modalAttributes = array(
    'tabindex' => '-1',
    'class'    => 'uk-modal-container uk-modal joomla-modal ' . implode(' ', $modalClasses)
);
...
?>
<div id="<?php echo $selector; ?>" role="dialog" <?php echo ArrayHelper::toString($modalAttributes); ?> <?php echo $url ?? ''; ?> <?php echo isset($url) ? 'data-iframe="' . trim($iframeHtml) . '"' : ''; ?> data-uk-modal>
    <div class="uk-modal-dialog uk-margin-auto-vertical modal-dialog modal-lg<?php echo $modalDialogClass; ?>">
        <?php
        // Header
