...
<div class="password-group">
    <div class="uk-button-group">
        ...
        <?php if (!$lock) { ?>
            <button type="button" class="uk-button uk-button-default input-password-toggle">
                <?php if ($jsIcons) { ?>
                <span data-uk-icon="icon:lock" aria-hidden="true" style="min-width:20px;"></span>
                <span class="visually-hidden uk-hidden"><?php echo Text::_('JSHOWPASSWORD'); ?></span>
                <?php } else { ?>
                <span><?php echo Text::_('JSHOWPASSWORD'); ?></span>
                <?php } ?>
            </button>
        <?php } else { ?>
            <button type="button" id="<?php echo $id; ?>_lock" class="uk-button uk-button-primary input-password-modify locked">
