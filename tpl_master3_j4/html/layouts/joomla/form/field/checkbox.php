...
?>
<input type="checkbox" name="<?php echo $name; ?>" id="<?php echo $id; ?>" class="uk-checkbox form-check-input<?php echo $class; ?>" value="<?php echo htmlspecialchars($value, ENT_QUOTES, 'UTF-8'); ?>" <?php echo $checked . $disabled . $onclick . $onchange . $required . $autofocus . $dataAttribute; ?>>
