...
<div id="<?php echo $id; ?>" class="<?php echo trim($class . ' checkboxes'); ?>" <?php echo $required ? 'required' : ''; ?> <?php echo $autofocus ? 'autofocus' : ''; ?> <?php echo $dataAttribute; ?>>
    <legend class="visually-hidden uk-hidden"><?php echo $label; ?></legend>
    ...
    <?php foreach ($options as $i => $option) { ?>
        ...
        $optionClass    = !empty($option->class) ? 'class="uk-checkbox form-check-input ' . $option->class . '"' : ' class="uk-checkbox form-check-input"';
        ...
        <div class="form-check form-check-inline">
            ...
            <label for="<?php echo $oid; ?>" class="form-check-label"></label>
        </div>
    <?php } ?>
</div>
